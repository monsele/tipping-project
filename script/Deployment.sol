...
contract DeployScript is Script {
    function run() external {
        ...
        address creator1 = 0x1234000000000000000000000000000000000000; // Replace with actual address
        address creator1Contract = factory.createCoffeeContract(
            "Creator1 Coffee Collection",
            "C1COFFEE",
            creator1
        );
